...
else if (notifyInterval==3&&task.data.treasureBox.count==0||task.data.treasureBox.count==10||task.data.treasureBox.count==20||task.data.treasureBox.count==30||task.data.treasureBox.count==40||task.data.treasureBox.count==50||task.data.treasureBox.count==60)
